...
export default function PropertyCard({ items }) {
    ...
    return (
        <section className="w-[35rem] shadow-lg flex flex-col mt-6 bg-white relative">
            {pathName === "/properties" ? <div className="bg-white/85 h-10 w-10 rounded-full absolute right-4 top-4 flex justify-center items-center">
